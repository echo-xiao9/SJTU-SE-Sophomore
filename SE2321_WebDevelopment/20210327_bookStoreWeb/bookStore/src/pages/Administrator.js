...
function createData(name, author, cover, ISBN, inventory) {
    return {name, author, cover, ISBN, inventory};
}

const rows = [
    createData('Harry Potter', 'J·K·Rowling', 37, '978-7-107-18618-1', 43),
    createData('Three body', 'Echo', 25, '978-7-107-18618-2', 49),
    createData('Eclair', 'Meec', 16, '978-7-107-18618-3', 60),
    createData('Frozen yoghurt', 'Liber', 6, '978-7-107-18618-4', 40),
    createData('Gingerbread', 'Alice', 16.0, '978-7-107-18618-5', 39),
    createData('Honeycomb', 'Bob', 3.2, '978-7-107-18618-6', 65),
...
const headCells = [
    {id: 'name', numeric: false, disablePadding: true, label: 'Book Name'},
...
const EnhancedTableToolbar = (props) => {
    ...
    return (
        ...
        color='secondary'
        type='number'//time
        label='ISBN/INVENTORY' //背景文字，之后会上浮
        placeholder="Number"
        fontSize='12'
        fullWidth
      /> */}
