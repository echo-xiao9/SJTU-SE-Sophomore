...
function renderAdmin() {
    ...
    if (localStorage.getItem('userType') === '1') return <Button buttonStyle='btn--outline'
                                                                 buttonLink='/AdminIndex'>Administrator</Button>;
    else return null;
}

function renderLogOut() {
    console.log(localStorage.getItem('userType'));
    if (localStorage.getItem('userType') != null) return <Button buttonStyle='btn--outline' onClick={logOut}>Log
        Out</Button>;
}
