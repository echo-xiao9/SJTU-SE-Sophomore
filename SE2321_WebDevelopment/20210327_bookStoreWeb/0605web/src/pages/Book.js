            ...
            <div className="w3-col l8 s12">
              ...
              <div className="w3-card-4 w3-margin w3-white" style={{ maxWidth: '1400px' }}>
                ...
                <div className="w3-container">
                  ...
                  <h5> J. K. Rowling <span className="w3-opacity">July 1, 2009</span></h5>
                </div>

                <div className="w3-container">
                  <p>Now for the first time ever, J.K. Rowling’s seven bestselling Harry Potter books are available in a stunning
                  paperback boxed set! The Harry Potter series has been hailed as “one for the ages” by Stephen King and “a
                  spellbinding saga’ by USA Today. And most recently, The New York Times called Harry Potter and the Deathly
                  Hallows the “fastest selling book in history.” This is the ultimate Harry Potter collection for Harry Potter
                  fans of all ages!
                </p>
                  <Button />
