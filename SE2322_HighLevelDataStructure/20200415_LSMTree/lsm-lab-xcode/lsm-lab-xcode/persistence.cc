...
//        }
//        
////        cout<<"start phase 3 put";
//        for (i = 1; i < max; i+=2){
//            if(i==2791) cout<<i<<" "<<store.get(i).length();
////            if(store.get(i)!= std::string(i+1, 's')){
////               cout<<i<<" "<<store.get(i).length();
////            }
//        }
////
//        
...
//		for (i = 0; i < max; ++i) {
//            if(store.get(2791).length()!=2792)cout<<"error"<<i<<" "<<store.get(2791).length();
////            cout<<"=2791?"<<store.get(2791).length();
//			switch (i & 3) {
//			case 0:
//                    if(store.get(i)!="")cout<<"case 0:"<<i<<"val:"<<store.get(i)<<endl;
//				store.put(i, std::string(i+1, 't'));
//				break;
//			case 1:
//                    if(std::string(i+1, 's')!= store.get(i))cout<<"case 1:"<<i<<"val "<<store.get(i).length()<<endl;
//				store.put(i, std::string(i+1, 't'));
//				break;
//			case 2:
//                    if(store.get(i)!="")cout<<"case 2"<<i<<endl;
//				break;
//			case 3:
//                    if(std::string(i+1, 's')!= store.get(i))
//                        cout<<"case 3 :"<<i<<"val:"<< store.get(i).length()<< endl;
//				break;
//			default:
//				assert(0);
//			}
